/* Template Factory - Dan Sheer live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-dansheer-riverside/';
  var LS_CHANGES = 'tf_dansheer_change_log_v1';
  var LS_PURCHASED = 'tf_dansheer_purchased_v1';
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Dan Sheer. Hang tight.',
        delay,
        function () {
